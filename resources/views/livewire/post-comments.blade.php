<div class="mt-10 comments-box border-t border-gray-100 pt-10">
  ...
  @auth
    <textarea placeholder="Post your comment here..." wire:model="comment"
  ...
  @else
    <div class="text-center">
      <a wire:navigate class="text-yellow-500 underline py-1" href="{{ route('login') }}">Login</a>
      to Post Comments
    </div>
  @endauth

  <div class="user-comments px-3 py-2 mt-2">
    @forelse ($this->comments as $comment)
      <x-posts.comments-list :key="$comment->id" :$comment />
    @empty
