<x-app-layout :title="$post->title">
  <article class="col-span-4 md:col-span-3 mt-10 mx-auto py-5 w-full max-w-[700px]">
    ...
    <div class="mt-2 flex justify-between items-center">
      <div class="flex py-5 text-base items-center text-gray-500">
        <x-posts.author :author="$post->author" size="md" />
        |
        <span class="text-gray-500 text-sm ms-2">{{ $post->getReadingTime() }} min read</span>
      </div>
    ...
    <div class="article-content py-3 text-gray-800 text-lg text-justify prose-lg">
      {!! $post->body !!}
    </div>
