<div x-data="{ searchTerm: '{{ request('search', '') }}' }" id="search-box">
    <div>
        ...
        <div class="w-52 flex rounded-2xl bg-gray-100 py-2 px-3 mb-3 items-center">
            ...
            <input
                ...
                x-on:keydown.enter="$dispatch('search', { search: searchTerm });">
        </div>
        <x-button x-on:click="$dispatch('search', { search: searchTerm });">
            Search
        </x-button>
    </div>
</div>
